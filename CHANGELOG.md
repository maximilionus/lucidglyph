## Development
- Full stem-darkening for the `autofitter` driver. This is a critical change
  that provides the fix for the improper shape geometry of some fonts but
  reintroduces the issue with icon-type fonts.
